          ...
          <CardContent className="prose max-w-none">
            <div className="space-y-6 text-gray-700 leading-relaxed">
              ...
              <section>
                ...
                <p className="mt-2">
                  For data deletion requests, please visit our <a href="/data-deletion-request" className="text-blue-600 hover:text-blue-800 underline">Data Deletion Request</a> page.
                </p>
              </section>
            </div>
          </CardContent>
