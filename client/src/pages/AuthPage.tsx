...
type SignupFormData = z.infer<typeof localSignupSchema>;
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  {isLogin ? t('signInWithFacebook') : t('signUpWithFacebook')}
                </Button>
              </div>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input {...field} type="email" placeholder={t('enterEmail')} className="pl-10" />
                            </div>
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <div className="relative">
                                ...
                                <Input {...field} placeholder={t('enterFirstName')} className="pl-10" />
                              </div>
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <div className="relative">
                                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-4 w-4" />
                                <Input {...field} placeholder={t('enterLastName')} className="pl-10" />
                              </div>
                            </FormControl>
                            <FormMessage />
                          </FormItem>
